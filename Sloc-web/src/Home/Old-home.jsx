...
//         logoTo1: { opacity: 1, y: 650, x: 100, scale: 0.5, duration: 3.8, scrub: 1.2},
//         scrollImageTo: { opacity: 0, duration: 0.15 },
//         pathsTo: { fill: '#06467973', stroke: '#06467973', duration: 2.5 },
//         logoTo2: { y: 1050, x: 0, scale: 0.05, duration: 2.9 },
//         logoTo3: { opacity: 0, duration: 0.4 },
//         scrollTrigger: { start: 'top 30%', end: 'bottom 20%', scrub: 1.2 },
//       };
//     } else if (width <= 574) {
//       props = {
...
//         pathsTo: { fill: '#06467973', stroke: '#06467973', duration: 0.55 },
//         logoTo2: { y: 1200, x: 35, scale: 0.08, duration: 3.2 },
...
//         scrollImageTo: { opacity: 1, y: 42, x: 332, scale: 0.58, duration: 0.2, scrub: 2},
//         pathsTo: { fill: '#06467973', stroke: '#06467973', duration: 0.6 },
//         logoTo2: { y: 576, x: 250, scale: 0.1, duration: 2.4 },
//         logoTo3: { opacity: 0, duration: 0.5 },
...
//         scrollImageTo: { opacity: 0, duration: 0.2 },
//         pathsTo: { fill: '#06467973', stroke: '#06467973', duration: 0.6 },
//         logoTo2: { y: 410, x: 316, scale: 0.1, duration: 2.4 },
//         logoTo3: { opacity: 0, duration: 0.5 },
//         scrollTrigger: { start: 'top 65%', end: 'bottom 35%', scrub: 0.5 },
//       };
//     } else if (width <= 1400) {
...
//         logoTo2: { y: 400, x: 470, scale: 0.1, duration: 2.5 },
//         logoTo3: { opacity: 0, duration: 0.5 },
...
//         pathsTo: { fill: '#06467973', stroke: '#06467973', scrub: 3 },
//         logoTo2: { y: 499, x: 549, scale: 0.1, duration: 3.2 },
//         logoTo3: { opacity: 0, duration: 0.5 },
//         scrollTrigger: { start: 'top 75%', end: 'bottom 45%', ease: 'power3.out', scrub: 2.3 },
//       };
//     } else if (width <= 1920) {
//       props = {
...
//         scrollImageTo: { opacity: 0, duration: 0.2 },
//         pathsTo: { fill: '#06467973', stroke: '#06467973', duration: 0.6 },
//         logoTo2: { y: 460, x: 709, scale: 0.1, duration: 2.5 },
//         logoTo3: { opacity: 0, duration: 0.5 },
//         scrollTrigger: { start: 'top center', end: 'bottom center', scrub: 0.5 },
//       };
//     }
...
//         props = {
//           fromTo: {
//             from: { opacity: 0, y: -200, x: 10 },
//             to: { opacity: 1, y: 20, x: 10,scale: 0.6, ease: 'power3.out', duration: 4.5 },
//           },
//           to: { opacity: 0, y: 550, x: -90, scale: 0, ease: 'power3.inOut', duration: 6, scrub: 1.9 },
//           scrollTrigger: { start: 'top 30%', end: 'bottom 20%', scrub: 0.8 },
//         };
//       } else if (width <= 574) {
//         props = {
//           fromTo: {
//             from: { opacity: 0, y: -250, x: 400 },
//             to: { opacity: 1, y: 30, x: 150, ease: 'power3.out', duration: 4.8 },
//           },
//           to: { opacity: 0, y: 750, x: 10, scale: 0, ease: 'power3.inOut', duration: 6.5 },
//           scrollTrigger: { start: 'top 75%', end: 'bottom 25%', scrub: 0.9 },
//         };
//       } else if (width <= 991) {
//         props = {
//           fromTo: {
//             from: { opacity: 0, y: -300, x: 600 },
//             to: { opacity: 1, y: 40, x: 200, ease: 'power3.out', duration: 5 },
//           },
//           to: { opacity: 0, y: 300, x: 200, scale: 0, ease: 'power3.inOut', duration: 7 },
//           scrollTrigger: { start: 'top 70%', end: 'bottom 30%', scrub: 1 },
//         };
//       } else if (width <= 1100) {
//         props = {
//           fromTo: {
//             from: { opacity: 0, y: -350, x: 800 },
//             to: { opacity: 1, y: 45, x: 300, ease: 'power3.out', duration: 5.2 },
//           },
//           to: { opacity: 0, y: 350, x: 300, scale: 0, ease: 'power3.inOut', duration: 7.2 },
//           scrollTrigger: { start: 'top 65%', end: 'bottom 35%', scrub: 1.1 },
//         };
//       } else if (width <= 1400) {
//         props = {
//           fromTo: {
//             from: { opacity: 0, y: -400, x: 900 },
//             to: { opacity: 1, y: 48, x: 400, ease: 'power3.out', duration: 5.3 },
//           },
//           to: { opacity: 0, y: 400, x: 400, scale: 0, ease: 'power3.inOut', duration: 7.3 },
//           scrollTrigger: { start: 'top 60%', end: 'bottom 40%', scrub: 1.1 },
//         };
//       } else if (width <= 1600) {
//         props = {
//           fromTo: {
//             from: { opacity: 0, y: -450, x: 1000 , scrub: 2},
//             to: { opacity: 1, y: 50, x: 500, ease: 'power3.out', duration: 7.5, scrub: 2 },
//           },
//           to: { opacity: 0, y: 500, x: 500, scale: 0, ease: 'power3.inOut', duration: 7.4 , scrub: 2},
//           scrollTrigger: { start: 'top 55%', end: 'bottom 45%', duration: 9.5,scrub: 3 },
//         };
//       } else if (width <= 1920) {
//         props = {
//           fromTo: {
//             from: { opacity: 0, y: -490, x: 1150,scale: 0.9 },
//             to: { opacity: 1, y: 39, x: 690, scale: 0.6, ease: 'power3.out', duration: 5.5 },
//           },
//           to: { opacity: 0, y: 470, x: 610, scale: 0, ease: 'power3.inOut', duration: 5.6, scrub: 3.2 },
//           scrollTrigger: { start: 'top center+=30px', end: 'bottom center-=-30px', scrub: 1.2 },
//         };
//       }
