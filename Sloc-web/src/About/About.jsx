...
function About() {
  return (
    <main className="aboutpage">
      <Helmet>
        <title>About SLOC | Leading Real Estate Company in India for Property Deals</title>
        <meta
          property="og:title"
          content="About SLOC | Leading Real Estate Company in India for Property Deals"
        />
        <meta
          property="og:description"
          content="Discover SLOC, your trusted real estate partner in India. We specialize in buying and investing in residential and commercial properties with expert guidance."
        />
      </Helmet>
