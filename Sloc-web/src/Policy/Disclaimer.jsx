...
const Disclaimer = () => {
  return (
    ...
    <>
                         <Helmet>
                     <meta property="og:title" content="Read Our Disclaimer | SLOC - Search Land of Choice" />
                     <meta property="og:description" content="Read the Disclaimer for SLOC, your trusted real estate partner. Learn about the terms, conditions, and legal information related to our property services and offerings." />
                    </Helmet>
